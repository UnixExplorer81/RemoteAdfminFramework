param(
    ...
    [hashtable]$UpdateDeployment = @{
        source = "\\dc-1\NAS\Scripts\PowerShell\UpdateDeployment\UpdateDeployment.psm1"
        target = "C:\Windows\System32\WindowsPowerShell\v1.0\Modules\UpdateDeployment\UpdateDeployment.psm1"
    }
)
